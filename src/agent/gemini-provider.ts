...
`;
    ...
    try {
      ...
      return {
        ...
        targetLedgerEntryId: parsed.targetLedgerEntryId ? String(parsed.targetLedgerEntryId) : undefined,
        suggestedReason: parsed.suggestedReason || "Action suggested by model.",
        requiredEvidenceTypes: Array.isArray(parsed.requiredEvidenceTypes) ? parsed.requiredEvidenceTypes : undefined,
